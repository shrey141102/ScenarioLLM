...
def main():
    ...
    RUN_DATA_PROCESSING = False  # Process the HighD data
    RUN_LLM_GENERATION = False  # Generate new scenarios with LLMs
    RUN_VISUALIZATION = True  # Generate visualizations for scenarios
    RUN_AGENT_ENHANCEMENT = False  # Enhance scenarios with CrewAI agents
    RUN_EVALUATION = False  # Run evaluation metrics and reports
