            ...
            if not st.session_state.scenarios:
                ...
                if results:
                    ...
                    if radar_buf:
                        ...
                        st.image(radar_buf, caption="Scenario Comparison Radar Chart", use_column_width=True)
    ...
    if st.session_state.progress >= 100:
        ...
        with tab3:
            ...
            if not st.session_state.evaluation_results:
                ...
                if radar_buf:
                    st.image(radar_buf, caption="Scenario Comparison Radar Chart", use_column_width=False)
